...
folder='H:\CDHPCDH CATCH DATA\May2021 onwards\14Feb2022-Cdh23EC12FcPcdh15PICA\newBatchPICA\0.08_processed-2022.02.17-19.15.50\ToSort\selectedcurves';
cd(folder);
        ...
        case 1;
            ...
            switch k2;
                case 3;
                    ...
                    %             delete(H_k);
                    namen = strcat('mod_single_0.08',name(end-10:end));
                    namel = name(end-10:end);
                    dlmwrite(namen, data,'delimiter','\t');
                    fprintf(fidn1, '%s %f %f\n',namel, l_time,force);
                    movefile(namen,'H:\CDHPCDH CATCH DATA\May2021 onwards\14Feb2022-Cdh23EC12FcPcdh15PICA\newBatchPICA\0.08_processed-2022.02.17-19.15.50\ToSort\selectedcurves\modified');
                    movefile(name,'H:\CDHPCDH CATCH DATA\May2021 onwards\14Feb2022-Cdh23EC12FcPcdh15PICA\newBatchPICA\0.08_processed-2022.02.17-19.15.50\ToSort\selectedcurves\checked');
                    delete(H_s);
                case 4
                    disp('multiplestep');
                    delete (H_f);
                    ...
                    force=(y3(c_info.DataIndex)+y3(d_info.DataIndex))/2;
                    %             delete(H_k);
                    namen = strcat('mod_multiple_0.08',name(end-10:end));
                    namel = name(end-10:end);
                    dlmwrite(namen, data,'delimiter','\t');
                    fprintf(fidn2, '%s %f %f\n',namel, l_time,force);
                    movefile(namen,'H:\CDHPCDH CATCH DATA\May2021 onwards\14Feb2022-Cdh23EC12FcPcdh15PICA\newBatchPICA\0.08_processed-2022.02.17-19.15.50\ToSort\selectedcurves\multiplemodified');
                    movefile(name,'H:\CDHPCDH CATCH DATA\May2021 onwards\14Feb2022-Cdh23EC12FcPcdh15PICA\newBatchPICA\0.08_processed-2022.02.17-19.15.50\ToSort\selectedcurves\multiplechecked');
                    delete(H_s);
            end
        case 2;
            delete (H_m);
